...
public class RenderLaser //extends Render
{
	...
	public void renderLaser(EntityLaser laser, double par2, double par4, double par6, float par8)
	{
		...
		float f2 = (float)laser.worldObj.getTotalWorldTime() + par8;
		float f3 = -f2 * 0.2F - (float)MathHelper.floor_float(-f2 * 0.1F);
		byte b0 = 1;
		double d3 = (double)f2 * 0.025D * (1.0D - (double)(b0 & 1) * 2.5D);
		tessellator.startDrawingQuads();
		tessellator.setColorRGBA(255, 0, 0, 32); // TODO: 
		...
		double d17 = (double)(256.0F) * (0.5D / d4) + d16;
	...
	protected ResourceLocation getLaserTexture(EntityLaser laser)
    {
        return this.laser;
    }
    ...
    {
        return this.getLaserTexture((EntityLaser) entity);
    }
