...
{	/*
	...
	public EntityLaser(World par1World, EntityPlayer player, double tx, double ty, double tz, float red, float green, float blue, int age)
	{
	...
	public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		switch (this.type) { default:
			UtilsFX.bindTexture("textures/misc/beam.png"); break;
		case 1:
			UtilsFX.bindTexture("textures/misc/beam1.png"); break;
		case 2:
		...
		if (this.impact > 0) renderImpact(tessellator, f, f1, f2, f3, f4, f5);
