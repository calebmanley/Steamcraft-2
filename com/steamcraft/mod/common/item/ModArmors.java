...
public class ModArmors 
{
	...
	public static void initArmors()
	{
		...
		brassGoggles = new ItemSC2Armor(SC2_ItemIDs.brassGogglesID, SC2_Material.STEAM_ARMOR, 0, 0).setUnlocalizedName("brassgoggles");
		aqualung = new ItemSC2Armor(SC2_ItemIDs.aqualungID, SC2_Material.STEAM_ARMOR, 0, 1).setUnlocalizedName("aqualung");
		legBraces = new ItemSC2Armor(SC2_ItemIDs.legBracesID, SC2_Material.STEAM_ARMOR, 0, 2).setUnlocalizedName("pneumaticbraces");
		rollerSkates = new ItemSC2Armor(SC2_ItemIDs.rollerSkatesID, SC2_Material.STEAM_ARMOR, 0, 3).setUnlocalizedName("rollerskates");
		
		helmetEtherium = new ItemSC2Armor(SC2_ItemIDs.helmetEtheriumID, SC2_Material.ETHERIUM_ARMOR, 0, 0).setUnlocalizedName("etheriumhelmet");
		plateEtherium = new ItemSC2Armor(SC2_ItemIDs.plateEtheriumID, SC2_Material.ETHERIUM_ARMOR, 0, 1).setUnlocalizedName("etheriumplate");
		legsEtherium = new ItemSC2Armor(SC2_ItemIDs.legsEtheriumID, SC2_Material.ETHERIUM_ARMOR, 0, 2).setUnlocalizedName("etheriumlegs");
		bootsEtherium = new ItemSC2Armor(SC2_ItemIDs.bootsEtheriumID, SC2_Material.ETHERIUM_ARMOR, 0, 3).setUnlocalizedName("etheriumboots");
		
		helmetObsidian = new ItemSC2Armor(SC2_ItemIDs.helmetObsidianID, SC2_Material.OBSIDIAN_ARMOR, 0, 0).setUnlocalizedName("obsidianhelmet");
		plateObsidian = new ItemSC2Armor(SC2_ItemIDs.plateObsidianID, SC2_Material.OBSIDIAN_ARMOR, 0, 1).setUnlocalizedName("obsidianplate");
		legsObsidian = new ItemSC2Armor(SC2_ItemIDs.legsObsidianID, SC2_Material.OBSIDIAN_ARMOR, 0, 2).setUnlocalizedName("obsidianlegs");
		bootsObsidian = new ItemSC2Armor(SC2_ItemIDs.bootsObsidianID, SC2_Material.OBSIDIAN_ARMOR, 0, 3).setUnlocalizedName("obsidianboots");
