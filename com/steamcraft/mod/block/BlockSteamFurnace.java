...
public class BlockSteamFurnace extends BlockContainer
{
	...
	{
		this.blockIcon = icon.registerIcon("steamcraft:steamfurnaceside");
		this.furnaceIconFront = icon.registerIcon(this.isActive ? "steamcraft:steamfurnacefronton" : "steamcraft:steamfurnacefrontoff");
		this.furnaceIconTop = icon.registerIcon("steamcraft:steamfurnacetop");
	}
