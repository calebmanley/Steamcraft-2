...
public class BlockChemicalFurnace extends BlockContainer
{
	...
	public BlockChemicalFurnace(int id, boolean flag)
	{
		...
		/*
		if(this.blockID == ModBlocks.chemOvenIdle.blockID)
		{
	...
	{
		this.blockIcon = icon.registerIcon("steamcraft:chemfurnaceside");
		this.furnaceIconFront = icon.registerIcon(this.isActive ? "steamcraft:chemfurnacefronton" : "steamcraft:chemfurnacefrontoff");
		this.furnaceIconTop = icon.registerIcon("steamcraft:castironblock");
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int l, float f1, float f2, float f3)
	{
		...
		if(furnace != null)
		{
			// TODO: ModLoader.OpenGUI(entityplayer, new GuiChemFurnace(entityplayer.inventory, tileentitychemfurnace));
		}
